...
<link rel="stylesheet" href="frontend/css/main.css?v=20260902c">
<link rel="icon" type="image/png" href="frontend/assets/img/logo.png">
<script src="frontend/js/theme-init.js?v=20260902c"></script>
...
<script src="frontend/js/i18n.js?v=20260902c"></script>
<script src="frontend/js/utils/helpers.js?v=20260902c"></script>
<script src="frontend/js/services/apiService.js?v=20260902c"></script>
<script src="frontend/js/services/authService.js?v=20260902c"></script>
<script src="frontend/js/services/catalogService.js?v=20260902c"></script>
<script src="frontend/js/services/cartService.js?v=20260902c"></script>
<script src="frontend/js/services/themeService.js?v=20260902c"></script>
<script src="frontend/js/services/settingsService.js?v=20260902c"></script>
<script src="frontend/js/services/notificationService.js?v=20260902c"></script>
<script src="frontend/js/components/layout.js?v=20260902c"></script>
<script src="frontend/js/components/cards.js?v=20260902c"></script>
<script src="frontend/js/pages/home.js?v=20260902c"></script>
</body>
</html>
